...
So, you read [Alex'
post](https://alex.smola.org/)
on applying the hashing trick to matrix factorization or [our
paper](https://proceedings.mlr.press/v9/karatzoglou10a/karatzoglou10a.pdf)
...
behavior](https://download.oracle.com/javase/6/docs/api/java/lang/Math.html#abs(int)).
But who reads documentation anyway? ;-) Thankfully, [Andrew](https://a1k0n.net/)
...
which, thankfully, [it
does](https://java.sun.com/docs/books/jls/third_edition/html/expressions.html#15.17.3).
